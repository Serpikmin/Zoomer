...
public class Neo4jDAO {
    ...
    public Result getNearbyDrivers(double longitude, double latitude, double radius) {
        String query = "MATCH (n: user)  WHERE point.distance(point({x:%f,y:%f, crs:'cartesian'}), point({x:n.longitude, y:n.latitude, crs:'cartesian'})) < %f and n.is_driver=true  RETURN n.uid, n.longitude, n.latitude, n.street";
