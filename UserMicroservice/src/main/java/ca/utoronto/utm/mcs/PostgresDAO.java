...
public class PostgresDAO {
    ...
    public void addUser(String email, String prefer_name, String password) throws SQLException {
        String query = "INSERT INTO users (email, prefer_name, password, rides) " +
                "VALUES ('%s', '%s', '%s', 0)";
        query = String.format(query, email, prefer_name, password);
        this.st.execute(query);
    }
